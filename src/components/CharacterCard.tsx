...
const CharacterCard = ({ name, title, image, description, village }: CharacterCardProps) => {
  const handleCardClick = () => {
    // Add click sound effect or animation
    console.log(`Selected character: ${name}`);
  };
  return (
    <Card 
      className="group hover:scale-105 transition-all duration-300 bg-gradient-to-br from-card to-card/80 border-border/50 hover:border-primary/50 relative overflow-hidden cursor-pointer" 
